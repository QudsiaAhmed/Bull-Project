            ...
            <div className='main-bg'>
                ...
                <div className='role-inner-div'>
                    <div className='role-question'>
                        <p className='Question-head'>Question 2 <span className='span-ques'>of 4</span></p>
                        <p className='Question-two'>What kind of products is your company<br />selling?</p>
                        <input type="text" class="form-control" id="label-role" name="username" placeholder="Sell products"/>
